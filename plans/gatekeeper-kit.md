...
- **Layer 2 second consumer: `mcp-shared`** drops its private copies of nonce and HTML modules in
  favor of the kit's leaf modules. No other existing gatekeeper is ported *to the assembly*;
